...
export default async function ultraPhase2contribute(zkeyNameOld, zkeyNameNew, name, entropy, logger) {
    await Blake2b.ready();
    ...
    zkeyUtils.hashG1(transcript1Hasher, curve, curContribution.delta1.g1_s);
    zkeyUtils.hashG1(transcript1Hasher, curve, curContribution.delta1.g1_sx);
    ...
    zkeyUtils.hashG1(transcript2Hasher, curve, curContribution.delta2.g1_s);
    zkeyUtils.hashG1(transcript2Hasher, curve, curContribution.delta2.g1_sx);
