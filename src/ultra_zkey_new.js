...
import {formatHash, log2} from "./misc.js";
...
export default async function newUltraZKey(r1csName, ptauName, zkeyName, indexesName, logger) {
    ...
    await fdZKey.writeULE32(ULTRAGROTH_PROTOCOL_ID);
    ...
    await fdZKey.write(bg2); // gamma_2
    await fdZKey.write(bg1); // delta_c1_1
    await fdZKey.write(bg2); // delta_c1_2
    await fdZKey.write(bg1); // delta_c2_1
    await fdZKey.write(bg2); // delta_c2_2
    csHasher.update(bg2U); // gamma_2
    csHasher.update(bg1U); // delta_c1_1
    csHasher.update(bg2U); // delta_c1_2
    csHasher.update(bg1U); // delta_c2_1
    csHasher.update(bg2U); // delta_c2_2
    ...
    await composeAndWritePoints(8, "G1", C1, "C1");
    await composeAndWritePoints(9, "G1", C2, "C2");
